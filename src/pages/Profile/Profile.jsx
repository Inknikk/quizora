...
import { getUserAccuracy, getUserLongestStreak } from '../../firebase/firestore';
import { logoutUser, updateUserDisplayName, resetUserProgress } from '../../firebase/auth';
import { ChevronLeft, LogOut, Flame, Target, Zap, Pencil, Trash2 } from 'lucide-react';
...
export default function Profile() {
  ...
  async function handleResetProgress() {
    ...
    try {
      ...
      setProfile(prev => ({ ...prev, totalQuizzes: 0, totalCorrect: 0, totalQuestions: 0, longestStreak: 0 }));
      setAccuracy(null);
      setLongestStreak(0);
    ...
    <div className="profile-page">
      ...
      <div className="profile-container">
        ...
        <div className="profile-stats">
          ...
          <div className="pstat glass"><Target size={20} className="ps-icon blue"/><div className="ps-val">{!loading && accuracy !== null ? `${accuracy}%` : loading ? '—' : '0%'}</div><div className="ps-lbl">Accuracy</div></div>
        ...
        <div className="modal-overlay" onClick={() => setShowResetModal(false)}>
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <p className="modal-desc">This will erase all your quiz history, stats, and accuracy. This cannot be undone.</p>
              <div className="modal-actions">
                <button className="btn-nav" onClick={() => setShowResetModal(false)}>Cancel</button>
                <button className="btn-submit" onClick={handleResetProgress}>Reset</button>
              </div>
            </div>
          </div>
        </div>
